...
public class RoleController {
    ...
    @RequestMapping(value = { "/admin/roles" }, method = RequestMethod.GET) public ModelAndView roles() {
        ModelAndView modelAndView = BaseController.setViewName("admin/role/roles");
        modelAndView.addObject("roles", BaseController.getList(roleRepository.findAll()));
        return modelAndView;
    }

    @RequestMapping(value = { "/admin/role-add" }, method = RequestMethod.GET) public ModelAndView addRole() {
        return BaseController.setViewName("admin/role/role-add");
    }

    @RequestMapping(value = { "/admin/role-update/{uuid}" }, method = RequestMethod.GET)
    ...
    @RequestMapping(value = { "/admin/role-delete/{uuid}" }, method = RequestMethod.GET)
